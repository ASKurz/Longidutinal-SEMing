...
Here's the simple univariate model for negative affect. It's based on the `model7.1a` model.
...
Now let's go bivariate. When doing this, make sure to include the within-lag residual covariances among the indicators. For more, check out Xiao Yang's [code](https://quantdev.ssri.psu.edu/tutorials/growth-modeling-chapter-8-multivariate-growth-models-and-dynamic-parameters).

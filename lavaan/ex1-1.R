#title:  Newsom Longitudinal SEM Chapter 1, Example 1.1
...
#lavaan syntax for example 1.1 (using ex 1-1.inp); the model syntax is put within '....'

model1.1 <- 'w1comp =~ w1vst1 + w1vst2 + w1vst3
...
fitmodel1.1 <- sem (model1.1, data = socex1.1)
summary (fitmodel1.1, fit.measures=TRUE, rsquare=TRUE, standardized=TRUE)

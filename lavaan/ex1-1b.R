#title:  Newsom Longitudinal SEM Chapter 1, Example 1.1b
...
#+++++++++++++++++++++++++++++++
# Chapter 1, Example 1.1b 
#+++++++++++++++++++++++++++++++

model1.1b <- #Factor identification;
...
fitmodel1.1b <- sem (model1.1b, data = socex1.1, meanstructure=TRUE)
summary (fitmodel1.1b, fit.measures = TRUE, rsquare = TRUE, standardized=TRUE)

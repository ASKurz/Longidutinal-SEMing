#title:  Newsom Longitudinal SEM Chapter 1, Example 1.2a
...
#+++++++++++++++++++++++++++++++
# Chapter 1, Example 1.2a 
#+++++++++++++++++++++++++++++++


model1.2a <- #Referent identification;
...
#Measurement intercept identification
		w1comp ~ 1
		w1vst1 ~ 0
		w1vst2 ~ 1
		w1vst3 ~ 1  '

fitmodel1.2a <- sem (model1.2a, data = socex1.1, meanstructure = TRUE)
summary (fitmodel1.2a, fit.measures = TRUE, rsquare = TRUE, standardized = TRUE)
#title:  Newsom Longitudinal SEM Chapter 2, Example 2.1
...
model2.1 <- #remove equality constraints to free loadings
...
fitmodel2.1 <- sem(model2.1, socex1.1)

summary (fitmodel2.1, fit.measures= TRUE, rsquare= TRUE, standardized= TRUE)

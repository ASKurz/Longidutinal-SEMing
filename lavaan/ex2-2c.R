#title:  Newsom Longitudinal SEM Chapter 2, Example 2.2c
...
#+++++++++++++++++++++++++++++++
# Chapter 2, Example 2.2c 
#+++++++++++++++++++++++++++++++

model2.2c <- 'w1comp =~ w1vst1 + a*w1vst2 + b*w1vst3
...
fitmodel2.2c <- sem(model2.2c, socex1.1)

summary (fitmodel2.2c, fit.measures= TRUE, rsquare= TRUE, standardized= TRUE)

#title:  Newsom Longitudinal SEM Chapter 2, Example 2.5b
...
#+++++++++++++++++++++++++++++++
# Chapter 2, Example 2.5b 
#+++++++++++++++++++++++++++++++

model2.5b <- 'w1comp =~ w1vst1 + a*w1vst2 + b*w1vst3
...
fitmodel2.5b <- sem(model2.5b, socex1.1, meanstructure= TRUE)

summary (fitmodel2.5b, fit.measures= TRUE, rsquare= TRUE, standardized= TRUE)

#title:  Newsom Longitudinal SEM Chapter 3, Example 3.5e
...
#+++++++++++++++++++++++++++++++
# Chapter 3, Example 3.5e 	SRMR is different
#+++++++++++++++++++++++++++++++

model3.5e <- '	w1posaff =~ w1happy + a*w1enjoy + b*w1satis + c*w1joyful + d*w1please
...
fitmodel3.5e <- sem(model3.5e, data=socex1.1, information="observed")
summary(fitmodel3.5e, fit.measures=TRUE, standardized=TRUE, rsquare=TRUE)

#title:  Newsom Longitudinal SEM Chapter 7, Example 7.1a
...
fitmodel7.1a <- growth(model7.1a, data=health1)
summary(fitmodel7.1a, fit.measures=TRUE, standardized=TRUE, rsquare=TRUE)

#title:  Newsom Longitudinal SEM Chapter 9, Example 9.5a
...
#+++++++++++++++++++++++++++++++
# Chapter 9, Example 9.5a 
#+++++++++++++++++++++++++++++++
#Note: differences from Mplus in the AIC, BIC, and loglikelihood values
#all other results are the same or close

#centered age as new variable 'age1'

attach(health1)
health1$age1 <- scale(age, center=TRUE, scale=FALSE)

model9.5a <- ' #define latent difference factors
...
fitmodel9.5a <- sem(model9.5a, data=health1, information = "observed")
summary(fitmodel9.5a, fit.measures=TRUE, standardized=TRUE, rsquare=TRUE)
